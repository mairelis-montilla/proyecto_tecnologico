    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M9 14l-4-4m0 0l4-4m-4 4h11a4 4 0 010 8h-1M20 10l4 4m0 0l-4 4m4-4H9a4 4 0 010-8h1"
        />
      </svg>
    ),
    roles: ['admin'],
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
