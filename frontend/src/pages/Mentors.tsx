...
const Mentors = () => {
  ...
  }, [debouncedSearch, selectedCategory, selectedSpecialties, minRating, priceRange, currentPage])
                    ...
                    >
                      <div className="flex gap-4">
                        ...
                        <div className="text-right flex-shrink-0">
                          <p className="text-2xl font-bold text-purple-600">${mentor.hourlyRate}</p>
